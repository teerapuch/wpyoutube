 ...
 */
function gossip_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'gossip_custom_header_args', array(
		'default-image'          => get_template_directory_uri() . '/img/banner-image.jpg',
...
add_action( 'after_setup_theme', 'gossip_custom_header_setup' );
